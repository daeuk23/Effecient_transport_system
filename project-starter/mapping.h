...
struct Map
{
    int squares[MAP_ROWS][MAP_COLS]; // Matrix representing the map
...
struct Route
{
    struct Point points[MAX_ROUTE]; // Points in the route
    int numPoints; // Number of points in the route
    char routeSymbol; // Symbol representing the route
};
